...
import { findPlaywrightChromium, launchChrome, buildStagehandLogger } from "./stagehand.js";
...
export class BrowserPool {
  ...
  async spawn(name: string, opts?: SpawnOptions): Promise<BrowserInstance> {
    ...
    const logger = buildStagehandLogger(this.costTracker, name);
    ...
    const browser = new BrowserInstance(name, stagehand, chrome.process, profileDir);
